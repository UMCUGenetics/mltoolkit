...
#plot_featureImportance(agg_coef, rm.features.all.zero = T, final.model.imp = fc)

plot_featureImportance <- function(df, title = NULL, sort = T, topn = F, rm.features.all.zero = F, final.model.imp = NULL, export.features = F)
{
